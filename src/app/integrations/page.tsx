      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center space-y-6 mb-16">
          <div className="inline-flex items-center space-x-2 px-3 py-1 border border-white/20 rounded">
            ...
            <span className="text-white/60 text-sm">Integration roadmap 2026</span>
          </div>
            ...
            <div className="relative flex items-start space-x-8">
              ...
              <div className="flex-1 bg-white/5 border border-white/20 rounded-lg p-8">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-white/50 text-sm">Expected: January 2026</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex items-start space-x-8">
              ...
              <div className="flex-1 bg-white/5 border border-white/20 rounded-lg p-8">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-white/50 text-sm">Expected: April 2026</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative flex items-start space-x-8">
              ...
              <div className="flex-1 bg-white/5 border border-white/20 rounded-lg p-8">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-white/50 text-sm">Expected: July 2026</span>
                </div>
              </div>
            </div>
          </div>
